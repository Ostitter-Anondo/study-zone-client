	...
	return (
		<div>
			{myMaterials.map((material) => (
				<div key={material._id} className="card bg-base-200 p-6 flex flex-col gap-6 mx-auto items-center w-11/12 md:w-9/12 lg:w-7/12">
            ...
            <h4 className="badge badge-secondary badge-sm mx-auto">{material.email}</h4>
            <a href={material.imgUrl} target="_blank" className="btn btn-xs btn-info mx-auto" download={material.imgUrl}>download image</a>
          </div>
