...
const Banner = () => {
  return (
    <div className="banner-container bg-fixed bg-center bg-base-300/50 bg-blend-multiply image-full w-full h-96">
      <div className="card-body h-full flex flex-col justify-between">
        <div className="w-7/12 backdrop-blur-sm p-7 rounded flex flex-col gap-6 text-justify">
